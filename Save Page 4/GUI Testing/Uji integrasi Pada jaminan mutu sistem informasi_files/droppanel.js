...
function ddpanel(setting){
	...
	if (window.addEventListener) //if non IE browsers, initialize panel window.onload
		...
		ddpanel.addEvent(window, function(e){setTimeout(function(){thispanel.initpanel(setting)}, 0)}, "load")
...
revealcontent:function(){
	...
	var thispanel=this
	setting.revealtimer=setTimeout(function(){thispanel.revealcontent()}, 0)
},
...
initpanel:function(){
	...
	setTimeout(function(){pcontent._actualheight=pcontent.scrollHeight}, 0)
...
var defaultpanel=new ddpanel({
	...
	pointerimage: {enabled: false, src: ["blank.gif", "blank.gif"]},
