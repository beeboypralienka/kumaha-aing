...
var tb_pathToImage = "http://stat.ks.kidsklik.com/statics/js/thickbox/loadingAnimation.gif";
var tb_closeImage = "http://stat.ks.kidsklik.com/statics/js/thickbox/tb-close.png";
	   ...
	   var urlType = baseURL.toLowerCase().match(urlString);
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			if(KeyVal[0] == 'mess'){
				...
				if(KeyVal[2])
					params['height'] = KeyVal[2];
				if(KeyVal[3])
					params['width'] = KeyVal[3];
			}
			else{
			...
			TB_HEIGHT = (params['height']*1) + 40 || 120; //defaults to 440 if no paramaters were added to URL
			...
			jQuery("#TB_closeWindowButton").click(tb_remove);
				...
				}else if(url.indexOf('TB_popup') != -1){	
					jQuery("#TB_ajaxContent").append(params['mess']);
					tb_position();
					jQuery("#TB_load").remove();
					jQuery("#TB_window").css({display:"block"}); 
